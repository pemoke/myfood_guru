...
// Webserver parameter
const PORT = 3000; //process.env.PORT || 8445;

// Wit.ai parameters
const WIT_TOKEN = "YH62EY6DRFQDVQVLJH526XQMCWWN7CRD"; //process.env.WIT_TOKEN;

// Messenger API parameters
const FB_PAGE_ID = 1607770722882179; //process.env.FB_PAGE_ID;
if (!FB_PAGE_ID) {
  throw new Error('missing FB_PAGE_ID');
}
const FB_PAGE_TOKEN = "EAAW2QkrRUoMBANZAd0KnDTxJNrtujz3pZC4cxTWqHXhWEXSp1bN0vRxXclOI095VC106L3JYJAuFNbPFTvT2HUis7SfxKi9KFMbcB0xPlASwkGFUC3HZCvq47sH0lwYf7Kc7NRJBqYHQHoZByWVWkYkEn692BnZAkG88MPXIKbAZDZD"; //process.env.FB_PAGE_TOKEN;
if (!FB_PAGE_TOKEN) {
